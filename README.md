...
snippets of Lisp code to the program for evaluation. You can get [that plugin here](extra/shaden.vim). Someone has also [ported the plugin to VSCode](https://github.com/semrekkers/shaden-vscode).
